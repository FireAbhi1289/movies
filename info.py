...
API_ID = int(environ.get('API_ID', '28746605'))
API_HASH = environ.get('API_HASH', '7b6d1acb937ad42ae8710a027ff420af')
BOT_TOKEN = environ.get('BOT_TOKEN', '7936495690:AAE4X4tiJDySJZl2VuQ3qy5SNjvSkuaQL90')
#---------------------------------------------------------------
#---------------------------------------------------------------
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002186564513'))
...
#---------------------------------------------------------------
#---------------------------------------------------------------
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://fireabhi1289:fireabhi@1289@moviebot1.lnp7j.mongodb.net/?retryWrites=true&w=majority&appName=Moviebot1")
DATABASE_NAME = environ.get('DATABASE_NAME', "Moviebot1")
